...
const customEnglishMessages: TranslationMessages = {
  ...
  resources: {
    ...
    'network/vendors': {
      ...
      helpers: {
        code: 'Unique vendor code used in NAS.vendor_code',
    ...
    system_config: {
      ...
      groups: {
        ...
        scheduler: {
          ...
          description: 'Scheduler and background task related settings',
        },
      },
      value_range: 'Range',
      min: 'Min',
  ...
  config: {
    ...
    scheduler: {
      max_workers: {
        title: 'Scheduler Max Workers',
        description: 'Maximum concurrent workers used by scheduler tasks (controls parallelism for tasks like latency checks).',
      },
    },
  },
  common: {
  ...
  dbms: {
    ...
    selectTableHint: 'Please select a table to browse data',
    sqlQuery: 'SQL Query',
    execute: 'Execute',
    createRow: 'Create New Row',
    editRow: 'Edit Row',
    confirmDelete: 'Confirm Delete',
    deleteMessage: 'Are you sure you want to delete this row? This action cannot be undone.',
    primaryKey: 'Primary Key',
    nullable: 'Nullable',
    required: 'Required',
    rowCreated: 'Row created successfully',
    rowUpdated: 'Row updated successfully',
    rowDeleted: 'Row deleted successfully',
    querySuccess: 'Rows affected: %{count}',
    queryExecuted: 'Query executed successfully',
    queryExecutedNoResults: 'Query executed successfully (no results)',
    ...
    tableDropped: 'Table dropped successfully',
    enterTableName: 'Please enter a table name',
    addColumns: 'Please add at least one column',
    // Alter Table
    ...
    confirmDropColumn: 'Confirm Drop Column',
    dropColumnMessage: 'Are you sure you want to drop column "%{column}"? This action cannot be undone.',
    confirmDropTable: 'Confirm Drop Table',
    dropTableMessage: 'Are you sure you want to drop table "%{table}"? All data will be lost and this action cannot be undone.',
    // Structure Tab (HeidiSQL style)
    structure: 'Structure',
    data: 'Data',
    query: 'Query',
    ...
    // Indexes, Foreign Keys, DDL (HeidiSQL style)
    indexes: 'Indexes',
    ...
    unique: 'Unique',
    primary: 'Primary',
    noIndexes: 'No indexes found on this table',
    constraintName: 'Constraint Name',
    referencedTable: 'Referenced Table',
    referencedColumn: 'Referenced Column',
    onUpdate: 'ON UPDATE',
    onDelete: 'ON DELETE',
    noForeignKeys: 'No foreign keys found on this table',
    copyDDL: 'Copy to Clipboard',
    copiedToClipboard: 'Copied to clipboard',
    noDDL: 'Could not generate DDL',
    // Backup
